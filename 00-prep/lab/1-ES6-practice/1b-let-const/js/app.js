...
let allProducts = [];
console.log(`type of allProducts is ${typeof(allProducts)}`);
...
let totalClicks = 0;
console.log(typeof(totalClicks));
const views = [];
const votes = [];
...
function displayPics(){
  ...
  // In the offending line of code, the variable "rando" was referenced outside the scope
    // of the code block where it was declared (namely the while loop inside the
